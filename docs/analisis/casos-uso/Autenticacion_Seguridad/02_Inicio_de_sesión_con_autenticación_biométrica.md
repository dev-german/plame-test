...
## Descripción
Este caso de uso describe el proceso de inicio de sesión con autenticación biométrica dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a inicio de sesión con autenticación biométrica.
