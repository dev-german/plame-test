...
Este caso de uso describe el proceso de doble autenticación (2fa) dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a doble autenticación (2fa).
