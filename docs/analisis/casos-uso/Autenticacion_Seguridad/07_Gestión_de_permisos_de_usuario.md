...
## Descripción
Este caso de uso describe el proceso de gestión de permisos de usuario dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a gestión de permisos de usuario.
