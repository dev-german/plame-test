...
## Descripción
Este caso de uso describe el proceso de gestión de dispositivos confiables dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a gestión de dispositivos confiables.
