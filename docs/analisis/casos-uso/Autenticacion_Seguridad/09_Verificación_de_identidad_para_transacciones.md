# Verificación de identidad para transacciones

## Descripción
Este caso de uso describe el proceso de verificación de identidad para transacciones dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a verificación de identidad para transacciones.
