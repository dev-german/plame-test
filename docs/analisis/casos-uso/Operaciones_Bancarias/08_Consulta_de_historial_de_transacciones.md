...
## Descripción
Este caso de uso describe el proceso de consulta de historial de transacciones dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a consulta de historial de transacciones.
