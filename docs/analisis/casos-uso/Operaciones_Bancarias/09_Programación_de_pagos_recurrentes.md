...
Este caso de uso describe el proceso de programación de pagos recurrentes dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a programación de pagos recurrentes.
