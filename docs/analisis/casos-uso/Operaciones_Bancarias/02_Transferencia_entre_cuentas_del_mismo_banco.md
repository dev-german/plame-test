...
## Descripción
Este caso de uso describe el proceso de transferencia entre cuentas del mismo banco dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a transferencia entre cuentas del mismo banco.
