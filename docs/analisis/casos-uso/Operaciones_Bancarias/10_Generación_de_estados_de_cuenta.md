...
## Descripción
Este caso de uso describe el proceso de generación de estados de cuenta dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a generación de estados de cuenta.
