...
Este caso de uso describe el proceso de transferencia a otros bancos dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a transferencia a otros bancos.
