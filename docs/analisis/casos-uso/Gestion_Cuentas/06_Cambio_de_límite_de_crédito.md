...
## Descripción
Este caso de uso describe el proceso de cambio de límite de crédito dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a cambio de límite de crédito.
