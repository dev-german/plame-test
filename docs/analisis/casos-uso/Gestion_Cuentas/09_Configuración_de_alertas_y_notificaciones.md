...
Este caso de uso describe el proceso de configuración de alertas y notificaciones dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a configuración de alertas y notificaciones.
