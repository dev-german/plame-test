# Consulta de beneficios y recompensas

## Descripción
Este caso de uso describe el proceso de consulta de beneficios y recompensas dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a consulta de beneficios y recompensas.
