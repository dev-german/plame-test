...
## Descripción
Este caso de uso describe el proceso de gestión de cuentas compartidas dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a gestión de cuentas compartidas.
