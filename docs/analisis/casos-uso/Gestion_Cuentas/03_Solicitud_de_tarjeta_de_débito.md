...
Este caso de uso describe el proceso de solicitud de tarjeta de débito dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a solicitud de tarjeta de débito.
