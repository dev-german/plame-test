...
Este caso de uso describe el proceso de bloqueo de tarjeta por pérdida o robo dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a bloqueo de tarjeta por pérdida o robo.
