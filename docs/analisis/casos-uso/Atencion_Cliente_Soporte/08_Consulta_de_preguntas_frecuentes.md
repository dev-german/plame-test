...
Este caso de uso describe el proceso de consulta de preguntas frecuentes dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a consulta de preguntas frecuentes.
