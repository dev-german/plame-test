...
## Descripción
Este caso de uso describe el proceso de encuestas de satisfacción dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a encuestas de satisfacción.
