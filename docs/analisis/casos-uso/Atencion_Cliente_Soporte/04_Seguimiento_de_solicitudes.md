...
Este caso de uso describe el proceso de seguimiento de solicitudes dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a seguimiento de solicitudes.
