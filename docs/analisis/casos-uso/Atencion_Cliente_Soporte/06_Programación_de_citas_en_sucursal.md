# Programación de citas en sucursal

## Descripción
Este caso de uso describe el proceso de programación de citas en sucursal dentro del sistema bancario.
...
2. Selecciona la opción correspondiente a programación de citas en sucursal.
